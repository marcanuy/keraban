"""
Django settings for keraban project.
...
MIDDLEWARE = [
    # 'django.middleware.security.SecurityMiddleware', #commented as sugguested by whitenoise docs
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.i18n', # https://docs.djangoproject.com/en/2.1/topics/i18n/translation/#get-current-language-bidi
...
WSGI_APPLICATION = 'keraban.wsgi.application'
